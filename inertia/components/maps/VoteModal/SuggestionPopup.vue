...
<template>
  ...
  >
    ...
    >
      ...
      <button
        class="text-white/75 rounded-full px-3 py-0.5 border border-transparent hover:(bg-white/5 color-white/100 border-white/15) transition-all duration-300 ease-in-out"
